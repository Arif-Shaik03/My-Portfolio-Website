...
const skills = [
  ...
  { name: "Git Pages", level: 75, category: "tools" },
  { name: "Jupiter Notebooks", level: 75, category: "tools" },
  { name: "Windows OS", level: 80, category: "tools" },
];
